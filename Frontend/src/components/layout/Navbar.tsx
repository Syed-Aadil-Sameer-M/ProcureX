...
export function Navbar({ toggleSidebar }: NavbarProps) {
  ...
  return (
    <header className="h-[56px] shrink-0 bg-white dark:bg-card border-b border-[#E2E8F0] dark:border-border flex items-center justify-between px-4 z-50 sticky top-0" data-testid="navbar">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold text-slate-900 dark:text-foreground tracking-tight hidden sm:block">ProcureX</span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        <button className="relative p-2 text-slate-600 dark:text-muted-foreground hover:bg-slate-100 dark:hover:bg-muted rounded-full" data-testid="button-notifications">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-56">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem onClick={logout} className="cursor-pointer text-red-600 focus:text-red-600" data-testid="menu-item-logout">
